...
import ru.urfu.taskmanager.libs.color_picker.PickerView;
import ru.urfu.taskmanager.libs.color_picker.recent.RecentColors;
import ru.urfu.taskmanager.view.editor.presenter.TaskEditorPresenter;
import ru.urfu.taskmanager.view.editor.presenter.TaskEditorPresenterImpl;
import ru.urfu.taskmanager.tools.ImageLoader;
import ru.urfu.taskmanager.view.main.view.TaskManager;
import ru.urfu.taskmanager.entities.TaskEntry;
import ru.urfu.taskmanager.tools.TimeUtils;

import static android.content.Context.VIBRATOR_SERVICE;
import static ru.urfu.taskmanager.view.main.view.TaskManagerActivity.REQUEST_CREATE;
import static ru.urfu.taskmanager.view.main.view.TaskManagerActivity.REQUEST_EDIT;
...
public class TaskEditorFragment extends Fragment implements TaskEditor, SingleDateAndTimePicker.Listener
{
    ...
    public static final String EDITED_ITEM_ID_KEY = "ru.urfu.taskmanager.view.editor.EDITED_ITEM_ID";
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return initView(inflater.inflate(R.layout.task_editor_fragment, container, false));
    }
