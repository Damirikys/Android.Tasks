...
import ru.urfu.taskmanager.db.DbTasksHelper;
import ru.urfu.taskmanager.db.filter.DbTasksFilter;
import ru.urfu.taskmanager.sync.BroadcastSyncManager;
import ru.urfu.taskmanager.tools.DirectoryChooser;
import ru.urfu.taskmanager.view.editor.view.EditorPagerFragment;
import ru.urfu.taskmanager.view.editor.view.TaskEditorFragment;
import ru.urfu.taskmanager.view.main.adapters.FiltersAdapter;
import ru.urfu.taskmanager.view.main.adapters.PermissionsAdapter;
import ru.urfu.taskmanager.view.main.adapters.SavedFiltersAdapter;
...
import ru.urfu.taskmanager.view.main.fragments.helper.CustomTransition;
import ru.urfu.taskmanager.view.main.presenter.TaskManagerPresenter;
import ru.urfu.taskmanager.view.main.presenter.TaskManagerPresenterImpl;

import static ru.urfu.taskmanager.view.editor.view.EditorPagerFragment.EDITOR_PAGER_POSITION;

@SuppressLint("Registered")
@EActivity(R.layout.activity_task_manager)
